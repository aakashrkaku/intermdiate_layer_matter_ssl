...
def get_args():
    ...
    parser.add_argument("--data_size", default=1, type=float, help="fraction of data")
    
    # Add model arguments
    parser.add_argument("--save_path",type=str)
    parser.add_argument("--mse_btwin", default=None, type=str)
    parser.add_argument('--from_scratch', type=str2bool, nargs='?',const=True, default=False)
    parser.add_argument('--only_ll', type=str2bool, nargs='?',const=True, default=False)
